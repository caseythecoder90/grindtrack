...
Two audits that drive the **running** app and fail on what a unit test cannot see. Both
need a real instance, real cookies and real credentials, so neither runs in CI.
