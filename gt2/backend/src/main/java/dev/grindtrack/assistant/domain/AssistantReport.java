...
/**
 * One drafted thing: a weekly review, a week of study blocks, a day's log, a morning brief, or a
 * batch of todos. Model output lands here and nowhere else; a person turns it into the real thing
 * by clicking, or does not.
 *
...
public class AssistantReport {
  ...
  public static final String KIND_TODO_BATCH = "todo_batch";
