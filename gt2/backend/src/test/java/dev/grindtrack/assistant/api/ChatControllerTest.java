...
class ChatControllerTest {
    ...
    when(chat.chat(isNull(), anyString(), any()))
        .thenAnswer(
            inv -> {
              ...
              return new ChatService.ChatReply(4L, "you are behind", 3000, 400, null, null, null);
            });
  ...
  void theQuestionAndTheConversationReachTheService() throws Exception {
    when(chat.chat(eq(9L), eq("and now?"), any()))
        .thenReturn(new ChatService.ChatReply(9L, "now this", 1, 1, null, null, null));
